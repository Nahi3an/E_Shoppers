...
if (isset($_POST['display-category-product'])) {

    include_once '../includes/dbh_inc.php';
    include_once '../includes/function_inc.php';

    $productInfo = getProductByCategory($conn, $_POST['category-id']);
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/online_shopping_system/cart.php" method="POST">
                                ...
                                <input type="submit" class="btn btn-primary btn-sm btn-block" name="add_to_cart_category" value="Add to cart">
                            </form>
